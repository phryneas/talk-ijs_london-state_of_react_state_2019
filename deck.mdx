...
const background = require("file-loader!./assets/iJS_London_2018_Template_1920x1080_49699_v1b.png");
const introSlide = require("file-loader!./assets/iJS_London_2018_Template_1920x1080_49699_v1a.png");
...
<Head>
  ...
  <style>
    {`
    body {
      background: white url('${background}') no-repeat fixed center;
